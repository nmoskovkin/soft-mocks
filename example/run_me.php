...
require_once \QA\SoftMocks::rewrite(__DIR__ . '/common.php');
// should be included rewritten if you want redefine external libs
require_once \QA\SoftMocks::rewrite(__DIR__ . '/../vendor/autoload.php');

require_once \QA\SoftMocks::rewrite(__DIR__ . '/SoftMocksExample.php');
