...
- so that trace would be readable you should apply patch for `phpunit` _[patches/phpunit7.x/phpunit_add_ability_to_set_custom_filename_rewrite_callbacks_1.patch](patches/phpunit7.x/phpunit_add_ability_to_set_custom_filename_rewrite_callbacks_1.patch)_;
- so that coverage would be right the you should apply patch to `phpunit` _[patches/phpunit7.x/phpunit_add_ability_to_set_custom_filename_rewrite_callbacks_2.patch](patches/phpunit7.x/phpunit_add_ability_to_set_custom_filename_rewrite_callbacks_2.patch)_ and patch to `php-code-coverage` _[patches/phpunit7.x/php-code-coverage_add_ability_to_set_custom_filename_rewrite_callbacks.patch](patches/phpunit7.x/php-code-coverage_add_ability_to_set_custom_filename_rewrite_callbacks.patch)_.

Use `phpunit6.x` directory instead of `phpunit7.x` for `phpunit6.x`.
Use `phpunit5.x` directory instead of `phpunit7.x` for `phpunit5.x`.
Use `phpunit4.x` directory instead of `phpunit7.x` for `phpunit4.x`.
...
```json
{
  "require-dev": {
    ...
    "phpunit/phpunit": "^7.5.9" // or "^6.5.5" or "^5.7.20" or "^4.8.35"
  }
}
```
